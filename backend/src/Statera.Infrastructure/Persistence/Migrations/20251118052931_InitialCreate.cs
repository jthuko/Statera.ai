        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Assignment_EndAfterStart", "[EndUtc] > [StartUtc]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemandTemplates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DailyHoursThreshold = table.Column<int>(type: "int", nullable: false),
                    WeeklyHoursThreshold = table.Column<int>(type: "int", nullable: false),
                    OvertimeMultiplier = table.Column<double>(type: "float", nullable: false),
                    HardBlock = table.Column<bool>(type: "bit", nullable: false),
                    PenaltyWeight = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesCatalog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RuleConstraints", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DemandTemplateDays",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DemandTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Day = table.Column<int>(type: "int", nullable: false),
                    Required = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemandTemplateDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DemandTemplateDays_DemandTemplates_DemandTemplateId",
                        column: x => x.DemandTemplateId,
                        principalTable: "DemandTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Units_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Availability_EndAfterStart", "[EndLocal] > [StartLocal]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TimeOff_EndAfterStart", "[EndUtc] > [StartUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationsCsv = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftTemplates_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DemandTemplateDays_DemandTemplateId_Day",
                table: "DemandTemplateDays",
                columns: new[] { "DemandTemplateId", "Day" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RolesCatalog_Position",
                table: "RolesCatalog",
                column: "Position",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_UnitId",
                table: "Schedules",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftTemplates_UnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffAvailabilities_StaffId_DayOfWeek_StartLocal",
                table: "StaffAvailabilities",
                columns: new[] { "StaffId", "DayOfWeek", "StartLocal" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeOffRequests_StaffId_StartUtc",
                table: "TimeOffRequests",
                columns: new[] { "StaffId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Units_FacilityId_Name",
                table: "Units",
